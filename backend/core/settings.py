...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-w&l)%7*dvn#-hgesdqy($2nag$rxfl&30z2v58*=b#&^41jcyt')
...
CORS_ALLOW_ALL_ORIGINS = True  # Enable CORS for static frontend in MVP
